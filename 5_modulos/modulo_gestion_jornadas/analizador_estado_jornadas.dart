...
class AnalizadorEstadoJornadas implements AnalizadorEstado {
  @override
  ...
  PaqueteVisualTarjeta analizar({
    ...
    if (esRechazadaPorPro) {
      ...
      estadoColor = ColoresApp.primarioVerde;
      estadoLabel = 'Turno aceptado';
    } else if (esPendiente) {
      if (esDueno) {
        int activeBids = trabajo.cantidadPujasTotales;
        if (activeBids == 0) {
          estadoLabel = 'Sin postulantes';
          estadoColor = Colors.grey;
        } else {
          estadoLabel = activeBids == 1 ? '1 postulante' : '$activeBids postulantes';
          estadoColor = ColoresApp.primarioVerde;
          usarPuntito = true;
        }
      } else {
        estadoLabel = 'Postulado';
        estadoColor = ColoresApp.primarioVerde;
      }
    } else {
    ...
    return PaqueteVisualTarjeta(
      ...
      iconoFallo: Icons.event_available_rounded,
    );
  }
